...
sc.subplots_Ra_scaling(Ra_ls[4:], eta_ls[1:], t1_grid=t1_grid[1:, 4:], end_grid=end_grid[1:, 4:],
                       ...
                       Ra_i='eff', save=True, fname='Ra-scaling-chaotic-eff',
...
sc.subplots_Ra_scaling(Ra_ls[4:], eta_ls[1:], t1_grid=t1_grid[1:, 4:], end_grid=end_grid[1:, 4:],
                       ...
                       Ra_i=True, save=True, fname='Ra-scaling-chaotic', compare_label='Moresi & Solomatov 1995', labelsize=14,
