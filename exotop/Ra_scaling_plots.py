...
from exotop.postaspect.setup_postprocessing import Ra_ls, eta_ls, t1_grid, end_grid, data_path, fig_path, c_rms, c_peak, c_regimes_td, fig_fmt, \
    regime_grid_td, regime_names_td, load_grid, alpha_m, p_Earth, postprocess_kwargs  # noqa: E402
...
sc.subplots_Ra_scaling(Ra_ls[4:], eta_ls[1:], t1_grid=t1_grid[1:, 4:], end_grid=end_grid[1:, 4:],
                       keys=['delta_rh', 'dT_rh', 'Nu'], data_path=data_path, fig_path=fig_path, load_grid=load,
                       Ra_i=True, save=True, fname='delta_rh-Nu-chaotic', labelsize=14,
