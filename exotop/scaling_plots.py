...
sc.subplots_topo_regimes(Ra_ls, eta_ls, regime_grid, regime_names, c_regimes=c_regimes, save=True, t1=t1_grid, load=load_grid,
                         fig_path=fig_path, fname='h_Ra_all', fig_fmt=fig_fmt, end=end_grid, labelsize=14, xlabel='Ra',
                         ylabel='dynamic topography (km)', xlabelpad=8, ylabelpad=10, fit=True, xlim=(1e6, 3e8),
                         ylim=(1, 9), logx=True, logy=True, hscale=2e-5 * 2700 * 2890, data_path=data_path)
...
sc.subplots_topo_regimes(Ra_ls, eta_ls, regime_grid, regime_names, c_regimes=c_regimes, save=True, t1=t1_grid, T_components=True,
                         load=load_grid, fig_path=fig_path, fname='h_T_all', fig_fmt=fig_fmt, end=end_grid,
                         labelsize=14, xlabel=r'$\alpha \delta_{rh} \Delta T_{rh}$', ylabel='dynamic topography',
                         xlabelpad=8, ylabelpad=12, fit=True, alpha_m=alpha_m, showallscatter=True, xlim=(3e-8, 7e-7),
