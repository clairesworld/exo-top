...
from useful_and_bespoke import cmap_from_ascii, SmoothDivergingColorMap
import os
...
wspace = 0.3
hspace = 0.3
c_h = 'xkcd:light purple'  #'xkcd:dark pastel green'  # 'xkcd:tealish green'
hlim = (-3e-2, 3e-2)
