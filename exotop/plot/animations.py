...
sys.path.insert(0, '//')
from exotop.postaspect.setup_postprocessing import Ra_ls, eta_ls, t1_grid, end_grid, data_path_bullard, data_path_home, fig_path_bullard, fig_path_home, c_rms, c_peak, \
...
from exotop.postaspect.aspect_post import get_cases_list  # noqa: E402
from exotop.postaspect import plt_1Dscaling as plt1  # noqa: E402
from exotop.postaspect import ani_aspect as anims  # noqa: E402
