...
from exotop.setup_postprocessing import Ra_ls, eta_ls, t1, end, data_path, fig_path, fig_fmt
...
for case in cases:
    ...
    for jj, Ra in enumerate(Ra_ls):
        ...
        sc.plot_T_profile(case, T_params=T_params, n=-1, data_path=data_path, t1=t1[ii, jj], setylabel=True,
