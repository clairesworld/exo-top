...
# chaotic
_ = plat.subplots_Ra_scaling(Ra_ls[4:], eta_ls[1:], t1_grid=t1_grid[1:, 4:], end_grid=end_grid[1:, 4:],
...
# steady state
_ = plat.subplots_Ra_scaling(Ra_ls[:3], eta_ls, t1_grid=t1_grid[:, :3], end_grid=end_grid[:, :3], keys=['delta_rh', 'dT_rh'],
                             ...
                             psuffixes=['_T'], title='Steady-state',
...
_ = plat.subplots_Ra_scaling(Ra_ls[4:], eta_ls[1:], t1_grid=t1_grid[1:, 4:], end_grid=end_grid[1:, 4:],
                             ...
                             cmap='winter', compare_pub=plat.moresi95,
                             fig_fmt=fig_fmt, fit=True, postprocess_kwargs=postprocess_kwargs)
# steady state
_ = plat.subplots_Ra_scaling(Ra_ls[:3], eta_ls, t1_grid=t1_grid[:, :3], end_grid=end_grid[:, :3], keys=['delta_rh', 'dT_rh'],
