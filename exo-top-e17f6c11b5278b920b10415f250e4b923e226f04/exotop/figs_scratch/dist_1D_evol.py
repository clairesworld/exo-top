...
yvars = ['T_m', 'eta_m', 'Ra_i_eff', 'h_dim_factor', 'dyn_top_rms', 'h_rad_m']
ylabels = [r'$T_{m}$ (K)', r'$\eta_m$ (Pa s)', r'Ra$_{i, {\rm eff}}$', r'$d_m \Delta T_m \alpha_m$', r'$h_{\rm rms}$ (m)', '$h_{rad}$ (W/kg)']
ylims = [(1450, 2250), (1e18, 1e23), (1e4, 1e12), (3e4, 3e5), (100, 3000), None]
log = [False, True, True, True, True, False]
yticks = None
xlabel = 'Time (Gyr)'
...
for ii, mass in enumerate(masses):
    ...
    fig, _ = plottop.plot_distribution(yvars, default='baseline', update_kwargs={'M_p': mass},
                                       # run_kwargs={'backwards_cooling': False},
...
plt.savefig('evol_dist_old.png', bbox_inches='tight')
plt.show()
